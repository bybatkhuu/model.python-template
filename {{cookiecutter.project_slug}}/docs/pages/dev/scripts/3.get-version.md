...
- `VERSION_FILE_PATH` is either loaded from the environment or, if it's not present in the environment, it defaults to `{{cookiecutter.module_name}}/__version__.py`.
